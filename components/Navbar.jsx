...
${isScrolled 
  ...
  : ''
    ...
    <div className='flex items-center gap-4'>
        <button onClick={toggleTheme} className='transition-transform duration-300 hover:scale-110'>
    ...
    ${isDarkMode 
      ? 'bg-dark-theme bg-opacity-95 text-white' 
      : 'bg-rose-50 text-gray-700'
        ...
        <li><a onClick={closeMenu} className={`hover:text-blue-500 transition-colors duration-300 ${isDarkMode ? 'text-white' : 'text-gray-700'}`} href='#top'>Home</a></li>
